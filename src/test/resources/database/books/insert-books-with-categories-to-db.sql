...
INSERT INTO books (id, title, author, isbn, price, description, cover_image, is_deleted)
VALUES (2, 'NewBookTitle2', 'NewBookAuthor2', 'NewBookIsbn2', 120, 'NewBookDescription2', 'NewCoverImage2', FALSE);
INSERT INTO books_categories (book_id, category_id) VALUES (2, 1);

INSERT INTO books (id, title, author, isbn, price, description, cover_image, is_deleted)
VALUES (3, 'NewBookTitle3', 'NewBookAuthor3', 'NewBookIsbn3', 200, 'NewBookDescription3', 'NewCoverImage3', FALSE);
